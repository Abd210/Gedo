    ...
    >
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <div className="mb-8">
          ...
          <a href={`tel:${phone}`} className="text-gedo-gold text-lg hover:underline">
            {phone}
          </a>
        </div>
        ...
        <div className="h-64 w-full rounded-lg overflow-hidden shadow-md">
          <iframe
            title="map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2848.1495794762375!2d26.11831591553598!3d44.448180579102395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1fff4c02a0a27%3A0x4b37b3303ef1d640!2sStrada%20Ion%20Maiorescu%2018%2C%20Bucure%C8%99ti%20030671!5e0!3m2!1sen!2sro!4v1691498320221!5m2!1sen!2sro"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
